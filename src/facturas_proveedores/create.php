...
$codfacturatmp=$_POST['codfacturatmp'];
    ...
    if($paciente["estado"]=="ok"){
       $datosguardados=1;
        ...
        //elimino las líneas de la tabla temporal
        $lineaFactura = new Consultas('factulineaptmp');
        $lineaFactura->Select();
    ...
    <div class="container-fluid">
        ...
        <form class="form-horizontal" id="formulario" action='create.php' method='post' enctype="multipart/form-data">
            ...
            <div class="col-xs-12">
                <div class="row">                            
                    ...
                    <div class="col-xs-2">
                        <input type="hidden" id="codproveedor" name="DATA[codproveedor]" value="">

                        <input type="text" class="form-control input-sm" id="Acodproveedor" value="" placeholder="<?php echo _('Proveedor'); ?>" required  data-index="1" >
                    </div>
        ...
        <div class="row">
            ...
            <form id="form_lineas" method="post" action="frame_lineas.php" target="frame_lineas">
                ...
                <input type="hidden" id="Bcodproveedor" name="codproveedor" value="">
