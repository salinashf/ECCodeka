	...
	<body>
		<div id="pagina">
			<div id="zonaContenido">
				<div align="center">
				<div id="tituloForm" class="header">INSERTAR PAGO DGI </div>
				<div id="frmBusqueda">
				<form id="formulario" name="formulario" method="post" action="guardar_pago.php">
					<table class="fuente8" cellspacing=0 cellpadding=2 border=0>
						...
						<tr><td>108        </td><td>IRAE - Anticipo                  </td><td><input name="f108" type="text" class="cajaTotales" id="f108" value="0" onchange="actualizar();"></td></tr>
						<tr><td>328        </td><td>IMPUESTO AL PATRIMONIO - Anticipo</td><td><input name="f328" type="text" class="cajaTotales" id="f328" value="0" onchange="actualizar();"></td></tr>
						<tr><td>546        </td><td>IVA - Contribuyente No CEDE      </td><td><input name="f546" type="text" class="cajaTotales" id="f546" value="0" onchange="actualizar();"></td></tr>
						<tr><td>606        </td><td>ICOSA Anticipo                   </td><td><input name="f606" type="text" class="cajaTotales" id="f606" value="0" onchange="actualizar();"></td></tr>
