...
$rs_factura=mysqli_query($GLOBALS["___mysqli_ston"], $sel_facturas); 
?>
...
<table width="85%" border="0">
  ...
  <tr>
    <td><span class="Estilo3">FECHA: <?php echo implota(mysqli_result($rs_factura, 0, "fechacobro"))?></span></td>
  </tr>
  <tr>
    <td><span class="Estilo3">FORMA PAGO: <?php echo mysqli_result($rs_factura, 0, "nombrefp")?></span></td>
  </tr>
</table>
<table width="85%" border="0">
  <tr>
...
$rs_lineas=mysqli_query($GLOBALS["___mysqli_ston"], $sel_lineas);
	...
	for ($i = 0; $i < mysqli_num_rows($rs_lineas); $i++) { 	
		...
		<tr>
			...
			<td width="18%" class="Estilo3"><div align="center"><?php echo number_format($precio,2,",",".")?></div></td>
  		</tr>
		<?php
	}
...
<table width="85%" border="0">
  <tr>
    <td class="Estilo3"><div align="right">Total: <?php echo $baseimponible?> Euros</div></td>
  </tr>
</table>
<br />
<table width="85%" border="0">
  <tr>
    <td class="Estilo3"><div align="left">Pagado: <?php echo number_format($pagado,2,",",".")?> Euros</div>      <div align="right"></div></td>
  </tr>
  <tr>
    <td class="Estilo3">A devolver: <?php echo number_format($adevolver,2,",",".")?> Euros</td>
  </tr>
</table>
<br />
<table width="85%" border="0">
