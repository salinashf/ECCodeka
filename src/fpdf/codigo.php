...
$sel_articulo="SELECT * FROM articulos WHERE codarticulo='$codigo'";
$rs_articulo=mysqli_query($GLOBALS["___mysqli_ston"], $sel_articulo);

$descripcion=mysqli_result($rs_articulo, 0, "descripcion_corta");
$referencia=utf8_decode(mysqli_result($rs_articulo, 0, "referencia"));
$codigobarras=mysqli_result($rs_articulo, 0, "codigobarras");
$descripcion=utf8_decode(substr($descripcion,0,31));
$precio=mysqli_result($rs_articulo, 0, "precio_tienda");
$precio=number_format($precio,2,",",".");

class PDF extends FPDF
{
function EAN13($x,$y,$barcode,$h=7,$w=.28)
{
	$this->Barcode($x,$y,$barcode,$h,$w,14);
}
