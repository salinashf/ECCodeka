...
class PDF_Label extends FPDF {
	...
	function Add_Label($text,$image) {
		...
		$this->Image($image,$_PosX,$_PosY-5,0,0,'PNG');
		$_PosX = $this->_Margin_Left + $this->_COUNTX*($this->_Width+$this->_X_Space) + $this->_Padding+$width/4;
		$this->SetXY($_PosX, $_PosY);
		$this->MultiCell($this->_Width - $this->_Padding-$width/4, $this->_Line_Height,$text, 0, 'L');
	}
