...
$fechainicio=explota($_POST['fechaini']);
...
$fechaDGI='';
$Total_Ventas=0;
$Acumulado_Ventas=$Cant_Compras=$Total_Compras=$Importe_Compras=$Total_pago_dgi=0;
$Importe_Ventas=$Iva_Compras=$Iva_Ventas=0;
	$tipo = array( 0=>"Contado", 1=>"Credito", 2=>"Nota Credito");
	$moneda = array();
	
							/*Genero un array con los simbolos de las monedas*/
							$tipomon = array();
							$sel_monedas="SELECT simbolo FROM monedas WHERE borrado=0 AND orden <3 ORDER BY orden ASC";
...
<table cellspacing="0" border="0">
	...
	<tr>
		...
		<td align="left"><br></td>
		<td align="left"><br></td>
		<td align="right" valign=bottom bgcolor="#FFFF00" sdval="0" sdnum="3082;0;0,000%"><font face="Calibri" color="#000000"></font></td>
		<td align="right" bgcolor="#FFFF00" sdval="761" sdnum="3082;">---</td>
		<td align="left"><br></td>
		<td align="left"><br></td>
		<td align="left"><br></td>
...
/*Recorro facturas de ventas*/
		 ...
		 if (mysqli_result($res_resultado, $contador, "moneda")==1){
		 $Importe_Ventas+=$total;		 
		 } else {
		 $Importe_Ventas+=$total*$tipocambio;
		 }
		 $total=0;  
            $contador++;
...
if(mysqli_result($res_resultado, $contador, "tipo")!=2) {
		...
		$total= mysqli_result($res_resultado, $contador, "totalfactura")*(-1);
		 ...
		 if (mysqli_result($res_resultado, $contador, "moneda")==1){
		 $Importe_Compras+=$total;		 
		 } else {
		 $Importe_Compras+=$total*$tipocambio;
		 }
		 $total=0;
...
?>	
	...
	<tr>
		...
		<td align="right" sdval="0" sdnum="3082;0;#.##0"><b><font face="Calibri" color="#000000">&nbsp;</font></b></td>
		<td align="right" sdval="<?php echo number_format($Total_Ventas,2,",",".");?>" sdnum="3082;0;#.##0"><b>
		<font face="Calibri" color="#000000">	<?php echo number_format($Total_Ventas,2,",",".");?>&nbsp;
		</font></b></td>
	...
	<tr>
		...
		<td align="right" valign=bottom sdval="8397" sdnum="3082;0;#.##0"><font face="Calibri" color="#000000"> </font></td>
		<td align="left" sdnum="3082;0;#.##0">=</td>
		<td align="right" sdval="8397" sdnum="3082;0;#.##0"></td>
		<td align="left">&nbsp;</td>
		<td align="right" sdval="0" sdnum="3082;0;#.##0"></td>
		<td align="left"><br></td>
		<td align="left" sdnum="3082;0;#.##0"><br></td>
		<td align="left" sdnum="3082;0;#.##0"><br></td>
		<td align="left" sdnum="3082;0;#.##0"><br></td>
