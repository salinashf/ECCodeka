...
<div class="container">
    <div class="row">
        <div class="col-xs-12">Usuarios que tienen horas pendientes de registrar para el mes de
        <?php 
    ...
    <thead>
        <tr>
            <th colspan="2" style=" background-color: #5DACCD; color:#fff">Día</th>
            <th style=" background-color: #5DACCD; color:#fff">Usuario/s</th>
        </tr>
    </thead>
    <tbody>
<?php
