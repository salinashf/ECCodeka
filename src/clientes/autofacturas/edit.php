...
logger($UserID, $oidestudio, $oidpaciente, $hace);
    ...
    $oidestudio = '';
    $oidpaciente = '';
    $hace = _('Ve datos factura '). $paciente["codautofactura"];
    $datosguardados=0;
    logger($UserID, $oidestudio, $oidpaciente, $hace);
...
<div id="exTab3" class="container">	
    ...
    <div class="container-fluid">
        ...
        <form class="form-horizontal" id="formulario" action='edit.php' method='post' enctype="multipart/form-data">
            ...
            <input type="hidden" name="DATA[codautofactura]" id="codautofactura" value="<?php echo $paciente["codautofactura"];?>" >
            <input type="hidden" name="codautofactura" value="<?php echo $paciente["codautofactura"];?>" >
            <input id="id" name="id" value="<?php echo $codautofactura?>" type="hidden">
            <div class="col-xs-12">
                <div class="row">                            
                    <label class="control-label col-xs-1"><?php echo _('Cliente'); ?></label>
                    <div class="col-xs-2">
                        <input type="hidden" id="codcliente" name="DATA[codcliente]" value="<?php echo $paciente["codcliente"];?>">
                        <?php
                            ...
                            ?>
                        <input type="text" class="form-control input-sm" id="Acodcliente" value="<?php echo $rowclientes["nombre"];?>" placeholder="<?php echo _('Proveedor'); ?>" required  data-index="1" readonly>
                    </div>
                    <label class="control-label col-xs-1"><?php echo _('RUT'); ?></label>
                    <div class="col-xs-2">
                        <input type="text" class="form-control input-sm" id="nrut" value="<?php echo $rowclientes["nif"];?>" placeholder="<?php echo _('RUT'); ?>" data-index="6" readonly>
                    </div>
                        <input type="hidden" id="Acodautofactura" name="DATA[codautofactura]" value="<?php echo trim($paciente["codautofactura"]);?>">
                ...
                <div class="row">    
                    ...
                    <select id="semanafacturacion" name="DATA[semanafacturacion]" class="form-control">
                        ...
                        $NoEstado=0;
                        foreach($tipof as $i) {
                            if ( $x==$paciente["semanafacturacion"]) {
                    ...
                    <div class="col-xs-1">
                    <input type="hidden" id="activa" name="DATA[activa]" value="<?php echo $paciente['activa'];?>" >
                    <?php
                ...
                <label class="control-label col-xs-1">&nbsp;<?php echo _('Moneda'); ?></label>
                        <div class="col-xs-1">
                            <select name="DATA[moneda]" id="Amoneda" class="form-control" onchange="cambio();" data-index="5" disabled>
                ...
                <div class="row"  style="position: absolute; bottom: 60px; left: 40px" >
                <label class="control-label col-xs-2"><?php echo _('Observación'); ?></label>
                    <div class="col-xs-6">
                        <textarea name="DATA[observacion]" rows="3" cols="70" class="form-control" id="observacion"><?php echo $paciente['observacion'];?></textarea>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <form id="form_lineas" method="post" action="frame_lineas.php" target="frame_lineas">
                ...
                <input type="hidden" id="Bcodcliente" name="codcliente" value="<?php echo $paciente["codcliente"];?>">
