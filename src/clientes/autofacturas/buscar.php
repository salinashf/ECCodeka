...
<div class="col-xs-12">
  <div class="row">
    <div class="col-xs-6">
      <div class="row">
        <div class="col-xs-4">
          <input placeholder="<?php echo _('Proveedor'); ?>" type="text" class="form-control input-sm keyupsubmit" id="proveedor" name="proveedor" autocomplete="off" onFocus="this.style.backgroundColor='#FFFF99'"  />
        </div>
        <div class="col-xs-4">
