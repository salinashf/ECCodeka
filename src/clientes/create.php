...
<div class="row">
 ...
 <!-- ////////////////////////////////  -->
    ...
    <div class="row">
        ...
        <div class="col-xs-2">
            <input type="text" class="form-control input-sm" id="pagodia" name="DATA[pagodia]" value="" placeholder="<?php echo _('Días de pago'); ?>"> 
        </div>        
...
<div class="form-group">
    ...
    <div class="row">
        ...
        <div class="col-xs-3">
            <input type="text" class="form-control input-sm" id="recepciondia" name="DATA[recepciondia]" value="" placeholder="<?php echo _('Días de recepción'); ?>"> 
        </div>        
        <label class="control-label col-xs-1"><?php echo _('Horario'); ?>&nbsp;</label>
        <div class="col-xs-3">
            <input type="text" class="form-control input-sm" id="recepcionhora" name="DATA[recepcionhora]" value="" placeholder="<?php echo _('Horario de recepción'); ?>"> 
        </div>        
