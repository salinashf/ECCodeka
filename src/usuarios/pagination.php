...
for ($x=$initial_num; $x<$condition_limit_num; $x++) {
    ...
    if (($x > 0) && ($x <= $total_pages)) {
        ...
        if ($x == $page) {
            ?>
            <script type="text/javascript">parent.form.page.value = <?php echo $x;?>; </script>
            <?php
...
?>
    ...
    <input type="hidden" value="" id="codusuarios"/>
...
<button class="btn btn-primary btn-xs" type="submit" id="modifica">F6</button> Modificar Datos
<button class="btn btn-primary btn-xs" type="submit" id="actividad">F9</button> Registro de actividades
<button class="btn btn-primary btn-xs" type="submit" id="nuevo">INS</button> Nuevo Usuario
