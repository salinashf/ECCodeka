...
$(document).ready(function(){
    ...
    $('.trigger').click(function(e){
        ...
        e.preventDefault();
        codlicencia= $(e.currentTarget).attr("data-codlicencia"); 
        parent.$('#codlicencia').val(codlicencia);
    });//Finaliza trigger


    $("#Modifico").click(function(e){ 
        //var codlicencia= $(e.currentTarget).attr("data-codlicencia"); 
        if(codlicencia > 0){
            var url = 'edit.php?codlicencia='+codlicencia;
...
function eliminar(cod, dir='licencia'){
...
function guardolicencia(){
    var desde=$("#desde").val();
    var hasta=$("#hasta").val();
    var codlicencia=$("#codlicencia").val();
    ...
    var datasend={"desde" : desde, "hasta": hasta, "codlicencia": codlicencia, "codusuarios": codusuarios};	
    $.ajax({ 
    type: "POST",
    url: "guardolicencia.php",
    cache: false,
    data: datasend,
    success: function(text){
            if (text != "0"){
              ...
              if(n>0){
                ...
                showToast(text,tipo);
                parent.$('#frame_licencia').attr( 'src', function ( i, val ) { return val; });
