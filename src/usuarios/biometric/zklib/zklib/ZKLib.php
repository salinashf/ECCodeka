...
class ZKLib
{
     ...
     * @return bool|mixed
     */
	public function testVoice($voice)
	{
        return (new ZK\Voice())->get($this, $voice);
	}
    ...
    {
        return (new ZK\Restart())->restart($this);
    }
    ...
    {
        return (new ZK\SetTimeout())->setTimeout($this, $sec, $usec);
    }
}