...
$(document).ready(function(){
    ...
    $('.trigger').click(function(e){
        ...
        e.preventDefault();
        codproveedor= $(e.currentTarget).attr("data-proveedor"); 
        parent.$('#codproveedor').val(codproveedor);
    });//Finaliza trigger


    $("#Modifico").click(function(e){ 
        //var codcliente= $(e.currentTarget).attr("data-proveedor"); 
        if(codcliente > 0){
            var url = 'edit.php?codcliente='+codcliente;
...
//alert(e.keyCode);
    switch(e.keyCode) { 
        ...
        case 45:
        var url = 'create.php';
        OpenWindow(url, form = 'form',w = '500' ,h = '400', Close = false, Scroll = false, CloseButton = false);
        break;
