...
<div class="col-xs-12">
  <div class="row">
    <div class="col-xs-6">
      <div class="row">
        <div class="col-xs-4">
          <input placeholder="<?php echo _('Cliente'); ?>" type="text" class="form-control input-sm keyupsubmit" id="cliente" name="nombre" autocomplete="off" onFocus="this.style.backgroundColor='#FFFF99'"  />
        </div>
        <div class="col-xs-4">
      ...
      <div class="row">
        ...
        <div class="col-xs-4">
            <select name="estado" id="estado" class="form-control onchangesubmit" >
              ...
              <option value="2" selected>Cobrada</option>	
              <?php }else { ?>
              <option value="1">Sin Cobrar</option>
              <option value="2" selected>Cobrada</option>	
              <?php } ?>
