				...
				if ($iniciopagina>$filas) { $iniciopagina=0; }
					if ($filas > 0) { ?>
						...
						<tr class="<?php echo $fondolinea?>">
							...
							<td><div align="center"><a href="#"><img id="botonBusqueda" src="../img/modificar.png" width="16" height="16" border="0" onClick="modificar_impuesto(<?php echo mysqli_result($res_resultado, $contador, "codimpuesto")?>)" title="Modificar"></a></div></td>
							<td><div align="center"><a href="#"><img id="botonBusqueda" src="../img/ver.png" width="16" height="16" border="0" onClick="ver_impuesto(<?php echo mysqli_result($res_resultado, $contador, "codimpuesto")?>)" title="Visualizar"></a></div></td>
							<td><div align="center"><a href="#"><img id="botonBusqueda" src="../img/eliminar.png" width="16" height="16" border="0" onClick="eliminar_impuesto(<?php echo mysqli_result($res_resultado, $contador, "codimpuesto")?>)" title="Eliminar"></a></div></td>
						</tr>
						<?php $contador++;
							}
						?>			
