...
// set page headers
$page_title = "Nuevo Familia artículos";
...
if($_POST)
{
    ...
    if($paciente["estado"]=="ok"){
        ...
        $codhorasestudio = '';
        $codhoraspaciente = '';
        $hace = _('Crea nuevo familia de articulos ').$paciente['id'];
...
<div class="panel panel-default">
        ...
        <div class="panel-heading">&nbsp;Detalles&nbsp;familia&nbsp;artículos</div>
        <div class="panel-body">

        <form id="form" class="form-horizontal" action='create.php' method='post'>
    <input type="hidden" name="DATA[codfamilia]" id="codfamilia" value="" >
...
<div class="col-xs-12">
    ...
    <div class="col-xs-8">
        <textarea rows="3" class="form-control" id="nombre" name="DATA[nombre]" placeholder="Descripción">Descripción</textarea>
    </div>
    </div>
    </fieldset>				
