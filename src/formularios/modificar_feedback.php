...
<body>
		<div id="pagina">
			<div id="zonaContenido">
				<div align="center">
				<div id="tituloForm" class="header">Modificar Línea Feedback </div>
				<div id="frmBusqueda">
				...
				<input  type="hidden" name="codfeedback" value="<?php echo $codfeedback;?>" />
					<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>
					   ...
					   $query_familias="SELECT * FROM formularios WHERE borrado=0 ORDER BY descripcion ASC";
				        ...
				        <tr>						
						  <td>Definición</td>
						  <td><textarea name="definicion" id="definicion" class="textArea" rows="6" cols="60" style="font-family: helvetica;font-size: 8pt;" id="<?php echo mysqli_result($rs_query, 0, "fila");?>">
						  <?php echo mysqli_result($rs_query, 0, "definicion");?></textarea>
						  </td>
						  </tr>	
					</table>
			  </div>
			  <br style="line-height:5px">
				<div>
						<button class="boletin" id="validar" onMouseOver="style.cursor=cursor"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp;Guardar</button>
...
<script type="text/javascript">
    ...
    "table contextmenu directionality emoticons template textcolor paste fullpage textcolor colorpicker textpattern code"
	],

	toolbar1: "bold italic underline strikethrough | alignleft aligncenter alignright alignjustify | forecolor backcolor | cut copy paste | searchreplace | bullist numlist ",
 	toolbar2: "styleselect formatselect fontselect fontsizeselect | outdent indent blockquote | undo redo | code | ",
 	toolbar3: "table | hr removeformat | subscript superscript | charmap emoticons | print fullscreen | ltr rtl | nanospell | visualchars visualblocks nonbreaking template pagebreak restoredraft",
...
$(document).ready(function(){
	 ...
	 $('#validar').click(function(e) {
			event.preventDefault();
			var mensaje="";
       	var	definicion=tinyMCE.activeEditor.getContent();
			if (definicion.length<=65) mensaje+="  - Falta definición<br>";
   		if ($("#tipoformulario").val()=="") mensaje+="  - Falta formulario<br>";
			if ($("#afila").val()=="") 	mensaje+="  - Faltan número de fila<br>"; 
			if ($("#Acompetencia").val()=="" ) 	mensaje+="  - Falta competencia<br>";
