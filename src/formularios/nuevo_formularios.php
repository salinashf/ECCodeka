...
function validar() 
			{
				...
				if (document.getElementById("descripcion").value=="") mensaje+="  - Falta descripción<br>";
				//if (document.getElementById("adias").value=="") 	mensaje+="  - Faltan días para la próxima evaluación<br>"; 
				if (document.getElementById("tipo").value=="") 	mensaje+="  - seleccione tipo<br>";
			...
			<div id="zonaContenido">
				...
				<form id="formulario" name="formulario" method="post" action="guardar_formularios.php">
					<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>
						<tr>
						  <td>Descripción</td>
						  <td><input name="Adescripcion" type="text" class="cajaGrande" id="descripcion" size="50" maxlength="50" value=""></td>
						  </tr><tr>
						<!--tr>
						  <td>Días para Feedback</td>
						  <td><input name="adias" type="text" class="cajaGrande" id="adias" size="50" maxlength="50" value=""></td>
						  </tr-->
						  <tr>						  
						  <td>Tipo</td><td>
