...
if ($cadena_busqueda<>"") {
	...
	$codformulario=$array_cadena_busqueda[1];
...
function OpenLeft(noteId,w,h){
window.parent.OpenLeft(noteId,w,h);
}
...
window.parent.OpenRight(noteId);
		...
		function nuevo_formulario() {
			window.parent.OpenLeft('nuevo_formularios.php');
		}
		...
		function hacer_cadena_busqueda() {
			...
			var descripcion=document.getElementById("descripcion").value;
			var cadena="";
			cadena="~"+codformulario+"~"+descripcion+"~";
			return cadena;
			}
		function firstpage() {
	...
	<body onLoad="inicio();">
		<div id="pagina">
			<div id="zonaContenido">
				<div align="center">
				<div id="frmBusqueda">
				<form id="form_busqueda" name="form_busqueda" method="post" action="rejilla_left.php" target="frame_rejilla">
					<table class="fuente8" cellspacing=0 cellpadding=2 border=0><tr>
							<input id="codformulario" type="hidden" class="cajaPequena" name="codformulario" maxlength="3" value="<?php echo $codformulario?>">
						<tr>
							<td>Descripción</td>
							<td><input id="descripción" name="descripcion" type="text" class="cajaGrande" maxlength="50" value="<?php echo $descripcion?>"></td>
						</tr>
					<tr><td colspan="2" align="center">
						...
						if ($escribir=="true") { ?>						
						<button class="boletin" onClick="nuevo_formulario();" onMouseOver="style.cursor=cursor">
						<i class="fa fa-plus" aria-hidden="true"></i>&nbsp;Nuevo&nbsp;formulario</button>
						<?php } ?>						
