...
function validar() 
			{
				...
				if ($("#Acompetencia").val()=="" || $("#definicion").val()=="") 	mensaje+="  - Falta competencia o definicion<br>";
...
<body>
		<div id="pagina">
			<div id="zonaContenido">
				<div align="center">
				<div id="tituloForm" class="header">Nueva Línea Formulario </div>
				<div id="frmBusqueda">
					...
					<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>
						<tr>
							...
							<td colspan="2">
								<?php
								$where='';
						if($codformulario<>'') {$where=" AND codformulario='".$codformulario."'"; $selected="selected";}
					   $query_familias="SELECT * FROM formularios WHERE borrado=0 ".$where." ORDER BY descripcion ASC";
						...
						<option value="0">Seleccione un formulario</option>
								...
								?> 
								<option value="<?php echo mysqli_result($res_familias, $contador, "codformulario")?>" <?php echo $selected;?>><?php echo mysqli_result($res_familias, $contador, "descripcion")?></option>
								<?php $contador++;
								} ?>				
								</select>
							</td>
				        ...
				        <tr>				
						  <td>Fila</td>
						  <td><input name="afila" id="afila"  type="text" class="cajaPequena2" id="fila" size="10" maxlength="10" value="	"></td>
						  </tr>
				        <tr>				
						  <td>Competencia</td>
						  <td><input name="Acompetencia" type="text" class="cajaGrande" id="competencia" size="200" maxlength="200" value=""></td>
						  </tr>						  
				        <tr>						
						  <td>Definición</td>
						  <td><textarea id="definicion" name="definicion" class="textArea" rows="6" cols="60" style="font-family: helvetica;font-size: 8pt;"></textarea>
						  </td>
						  </tr>	
					</table>
			  </div>
			  <br style="line-height:5px">
				<div>
						<button class="boletin" onClick="validar();" onMouseOver="style.cursor=cursor"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp;Guardar</button>
