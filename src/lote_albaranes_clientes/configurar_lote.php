...
$rs_albaranes=mysqli_query($GLOBALS["___mysqli_ston"], $select_albaranes); 
				...
				<form id="formulario" name="formulario" method="post" action="guardar_facturacion.php">
					...
					while ($contador < mysqli_num_rows($rs_albaranes)) {
						...
						<tr>
						    ...
						    <td width="15%"><?php echo mysqli_result($rs_albaranes, $contador, "codalbaran");?></td>
				            <td width="20%">Importe sin iva</td>
							<td width="15%"><?php echo number_format($totalalbaransiniva,2,",",".");?> &#8364;</td>
							<td width="20%">Importe con iva (<?php echo $iva?>%)</td>
							<td width="15%"><?php echo number_format($totalalbaran,2,",",".");?> &#8364;</td>
						</tr>
					<?php $totalfactura=$totalfactura+mysqli_result($rs_albaranes, $contador, "totalalbaran");
					   $contador++;
						} ?>
						<tr>
							<td width="15%"></td>
						...
						<tr>
							...
							<td width="15%"><?php echo number_format($totalfacturasiniva,2,",",".");?> &#8364;</td>
							<td width="20%">Total facturaci&oacute;n con iva</td>
							<td width="15%"><?php echo number_format($totalfactura,2,",",".");?> &#8364;</td>
						</tr>
						<tr>
							<td width="15%">IVA</td>
