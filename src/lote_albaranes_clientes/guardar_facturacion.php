...
$rs_factura=mysqli_query($GLOBALS["___mysqli_ston"], $ins_factura);
$codfactura=((is_null($___mysqli_res = mysqli_insert_id($GLOBALS["___mysqli_ston"]))) ? false : $___mysqli_res);
...
$rs_alb=mysqli_query($GLOBALS["___mysqli_ston"], $act_alb);
