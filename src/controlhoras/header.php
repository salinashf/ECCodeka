...
<script src="validar.js?u=<?php echo time();?>" type="text/javascript"></script>
...
$("#msganio",top.document).html("<i class='fa fa-long-arrow-right' aria-hidden='true'></i>&nbsp; <?php echo _('Control horas');?>");
