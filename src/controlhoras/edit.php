...
<div class="panel panel-default">
    ...
    <form id="formulario" class="form-horizontal" action='edit.php?codhoras=<?php echo $codhoras; ?>' method='post'>
    ...
    <div class="form-group">
        ...
        <div class="form-group">
            ...
            <?php
                ...
                <button class="btn btn-primary left-margin btn-xs" onclick="event.preventDefault();validar();"><?php echo _('Guardar'); ?></button>
                <?php } ?>
