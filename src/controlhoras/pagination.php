...
<button class="btn btn-primary btn-xs" id="Modifico">F6</button><?php echo _('Modificar');?>
<button class="btn btn-primary btn-xs" id="Nuevo"><i class="fa fa-clock-o" aria-hidden="true"></i>INS</button><?php echo _('Nuevo Registro');?>
