...
$pagina=array(0=>'mantenimiento_14.php',1=>'mantenimiento_15.php' );
/*La estructura de l array es: titulo pagina anterioer, titulo pagina sigiente*/
$titulo=array( 0=>'3.14 Tipo de Cambio', 1=>'3.15. Impuestos');
...
*/
$seccion=array( 0=> array(0=>'3.14.1. Alta nuevo Tipo de Cambio.',
													      1=>'Se tienen dos formas de dar de alta un Tipo de Cambio.<br>
													      <ul><li>Clic en Nuevo T.C. se nos habre una ventana para ingresar un solo tipo de cambio</li>
													      <li>Al hacer clic en el botón Obtener cotización, se abre un aventana donde en forma automática se obtiene
													      la/s últma/s cotizaciones desde el BCU</li></ul>',
													      2=>'../../_images/scrAltaTipoCambio.png',
													      3=>'Partes principales de la pantalla alta Tipo de Cambio',
											...
											1=> array(0=>'3.14.1.a Acciones sobre cada Tipo de Cambio.',
													      1=>'En el listado de Tipo de Cambios, a la derecha están estos botones.',
													      2=>'../../_images/scrAltaArticulosTransito0.png',
													      3=>'Modificar, Ver, Dar de baja',
													      4=>'',
													      5=>'',
													      ),
											2=> array(0=>'3.14.1.c. Modificar una Tipo de Cambio.',
													      1=>'Esta ventana nos permite modificar los datos del Tipo de Cambio.',
													      2=>'../../_images/scrModificarTipoCambio.png',
													      3=>'Partes principales de la pantalla modificar Tipo de Cambio',
													      4=>'',
													      5=>'
											...
											3=> array(0=>'3.14.1.d. Dar de baja una Tipo de Cambio.',
													      1=>'Esta ventana nos muestra los datos del Tipo de Cambios para verificar que es el que queremos dar de baja.',
													      2=>'../../_images/scrEliminarTipoCambio.png',
													      3=>'',
													      4=>'<ol class="arabic simple">
													      <li>Al hacer clic en el boton <em class="guilabel">Eliminar</em>, da de baja el Tipo de Cambios.</li>
