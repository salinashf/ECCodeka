...
$pagina=array(0=>'../04_documentos.php',1=>'documentos_021.php' );
/*La estructura de l array es: titulo pagina anterioer, titulo pagina sigiente*/
$titulo=array( 0=>'4. Menú Documentos', 1=>'4.2.1.  Altas, Bajas, Modificaciones Ventas.');
...
*/
$seccion=array( 0=> array(0=>'4.2. Principal Ventas',
													      1=>'Esta es una de las pantalla más utilizadas del sistema.',
													      2=>'../../_images/scrVentas.png',
													      3=>'Partes principales de la pantalla facturas',
													      4=>'<ol class="arabic simple"><li>Botones de acción: en el panel superior de la pantalla, 
													      tenemos los botones que nos permiten ingresar nueva factura de venta, 
													      ...
													      de datos el cliente no se borra, se quita del listado.</li>
													      <li>Enviar copia por mail al cliente</li>
													      </ul></li></ol>',
													      5=>'<div class="admonition note"><p class="first admonition-title">Nota</p>
													      <p><strong>Factura seleccionada</strong></p>
													      <p class="last">Al seleccionar una factura queda la fila resatada, 
