...
$pagina=array(0=>'documentos_03.php',1=>'documentos_05.php' );
/*La estructura de l array es: titulo pagina anterioer, titulo pagina sigiente*/
$titulo=array( 0=>'4.3.  Cobros rápidos', 1=>'4.5  Compras.');
...
*/
$seccion=array( 0=> array(0=>'4.4. Principal Cobros',
													      1=>'Muy similar a cobros rápidos, despliega todos los cobros realizados.',
													      2=>'../../_images/scrCobros.png',
													      3=>'Partes principales de la pantalla cobros',
													      ...
													      <li>Acciones sobre cada factura: 
													      <ul><li>Modificar recibo.</li>
													      <li>Ver recibo.</li>
													      <li>Enviar recibo al cliente por mail.</li> 
													      <li>Eliminar recibo.</li>
													      </ol>',
													      5=>'',
													      ),
											1=> array(0=>'4.3.1 Ventana ingreso de cobros',
													      1=>'',
													      2=>'../../_images/scrAltaCobro.png',
													      3=>'',
													      4=>'La pantalla de divide en tres áreas
													      <ol class="arabic simple"><li>Datos del cliente - al comenzas a escribir el nombre del cliente nos aparece la opción para 
													      seleccionarlo.</li>
